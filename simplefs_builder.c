...
int find_free_inode(unsigned char *bitmap) { (void)bitmap; return -1; }   // not used in builder
...
int main(int argc, char *argv[])
{
    ...
    /* TODO: STUDENT CODE START */
    set_bit(inode_bitmap, 0);   // bit 0 corresponds to inode 1
    /* TODO: STUDENT CODE END */
    ...
    /* TODO: STUDENT CODE START */
    set_bit(data_bitmap, 0);    // index 0 corresponds to absolute block 4 (root directory)
    /* TODO: STUDENT CODE END */
    ...
    root_inode.links = 2;
    root_inode.size = 2 * DIRENT_SIZE;   // 128 bytes for "." and ".."
    root_inode.direct[0] = ROOT_DATA_BLOCK;   // 4
